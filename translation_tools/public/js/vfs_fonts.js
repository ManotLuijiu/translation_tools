...
export const initThaiPdfMake = async () => {
  try {
    ...
    const fontNormal = await loadFont(
      '/assets/translation_tools/fonts/Sarabun/Sarabun-Regular.ttf'
    );
    const fontBold = await loadFont(
      '/assets/translation_tools/fonts/Sarabun/Sarabun-Bold.ttf'
    );
    const fontItalic = await loadFont(
      '/assets/translation_tools/fonts/Sarabun/Sarabun-Italic.ttf'
    );
    const fontBoldItalic = await loadFont(
