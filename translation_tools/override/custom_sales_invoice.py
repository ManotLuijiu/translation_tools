...
from translation_tools.override.custom_pdf import get_pdf
    ...
    def generate_and_attach_pdf(self):
        ...
        try:
            ...
            if existing_file:
                ...
                file_doc.file_size = len(pdf_content)  # type: ignore
                file_doc.content = base64.b64encode(pdf_content).decode("utf-8")  # type: ignore
            ...
            frappe.log_error(
                f"Failed to generate PDF for {self.name}: {str(e)}",
